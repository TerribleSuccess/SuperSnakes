...
void printMarioRightJump(int x, int y) {
    ...
    safePrint(y+1, x+22, "  ", COLOR_PAIR_SKIN);
    ...
    safePrint(y+2, x+19, "     ", COLOR_PAIR_RED);
    ...
    safePrint(y+3, x+22, "  ", COLOR_PAIR_RED);
    ...
    safePrint(y+5, x+22, "  ", COLOR_PAIR_RED);

    safePrint(y+6, x+6, "              ", COLOR_PAIR_SKIN);
    safePrint(y+6, x+20, "    ", COLOR_PAIR_RED);
