...
void printWin(){
    ...
    safePrint(y+1, x+32,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+1, x+34,  "  ", COLOR_PAIR_RED);
    safePrint(y+1, x+36,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+1, x+38,  "  ", COLOR_PAIR_RED);
    safePrint(y+1, x+40,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+1, x+42,  "  ", COLOR_PAIR_RED);
    safePrint(y+1, x+44,  "      ", COLOR_PAIR_WHITE);
    safePrint(y+1, x+48,  "    ", COLOR_PAIR_RED);
    ...
    safePrint(y+2, x+32,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+2, x+34,  "  ", COLOR_PAIR_RED);
    ...
    safePrint(y+2, x+48,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+2, x+50,  "  ", COLOR_PAIR_RED);


    safePrint(y+3, x, "    ",COLOR_PAIR_RED);
    safePrint(y+3, x+4, "  ", COLOR_PAIR_WHITE);
    safePrint(y+3, x+6, "    ", COLOR_PAIR_RED);
    ...
    safePrint(y+3, x+32,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+3, x+34,  "  ", COLOR_PAIR_RED);
    ...
    safePrint(y+4, x+29,  "        ", COLOR_PAIR_WHITE);
    safePrint(y+4, x+37,  "   ", COLOR_PAIR_RED);
    safePrint(y+4, x+40,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+4, x+42,  "  ", COLOR_PAIR_RED);
    safePrint(y+4, x+44,  "  ", COLOR_PAIR_WHITE);
    safePrint(y+4, x+46,  "  ", COLOR_PAIR_RED);
